...
async function verifyApiKey(req, res, next) {
  ...
  // Pour les requêtes depuis GitHub Pages, on autorise sans clé (optionnel)
  ...
  try {
    ...
    // Headers de limite
    const remaining = 1000 - ((keyData.dailyUsage || 0) + 1);
    const resetIn = 86400 - (Date.now() % 86400);
    ...
    res.set({
      ...
      'X-RateLimit-Reset': String(Math.floor(resetIn / 1000))
    });
